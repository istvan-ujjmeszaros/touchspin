...
When initializing TouchSpin through data attributes, the correct format is `data-bts-[setting]`. For example, to set the step to 5, you would use `data-bts-step="5"`.
