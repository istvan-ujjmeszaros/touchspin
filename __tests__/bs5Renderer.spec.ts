...
test.describe('Bootstrap 5 Renderer', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    await page.goto('/__tests__/html-renderers/bs5-renderer-test.html');
  });

  test.afterEach(async ({ page }) => {
    await apiHelpers.collectCoverage(page, 'bs5-renderer');
  });
  ...
  test.describe('Dynamic Settings Updates - Normal Input', () => {
    ...
    test('should update addon classes (prefix_extraclass/postfix_extraclass)', async ({ page }) => {
      ...
      expect(prefixClass).toContain('bs5-test-prefix-extra');
      expect(postfixClass).toContain('bs5-test-postfix-extra');
      ...
      expect(prefixClass2).not.toContain('bs5-test-prefix-extra');
      expect(postfixClass2).not.toContain('bs5-test-postfix-extra');
  ...
  test.describe('Dynamic Settings Updates - Advanced Container', () => {
    ...
    test('should preserve existing container structure', async ({ page }) => {
      ...
      const originalElements = apiHelpers.getElement(page, 'advanced-container').locator('.input-group-text');
