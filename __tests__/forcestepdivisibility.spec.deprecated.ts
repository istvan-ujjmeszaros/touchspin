...
test.describe('Core TouchSpin Force Step Divisibility', () => {
  ...
  test.describe('Round Mode (Default)', () => {
    test('should round value to nearest step multiple on initialization', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { step: 3, initval: 20, forcestepdivisibility: 'round' });
    ...
    test('should round up when value is halfway between steps', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { step: 4, initval: 14, forcestepdivisibility: 'round' });
    ...
    test('should round decimal values to step multiples', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { step: 0.25, initval: 5.13, forcestepdivisibility: 'round' });
  ...
  test.describe('Floor Mode', () => {
    test('should floor value to step multiple when forcestepdivisibility is floor', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { step: 3, initval: 20, forcestepdivisibility: 'floor' });
    ...
    test('should floor decimal values correctly', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { step: 0.25, initval: 5.13, forcestepdivisibility: 'floor' });
  ...
  test.describe('Ceil Mode', () => {
    test('should ceil value to step multiple when forcestepdivisibility is ceil', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { step: 3, initval: 20, forcestepdivisibility: 'ceil' });
    ...
    test('should ceil decimal values correctly', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { step: 0.25, initval: 5.13, forcestepdivisibility: 'ceil' });
  ...
  test.describe('None Mode', () => {
    test('should not modify value when forcestepdivisibility is none', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { step: 3, initval: 20, forcestepdivisibility: 'none' });
    ...
    test('should allow non-step-divisible values with none mode', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { step: 3, initval: 20.5, forcestepdivisibility: 'none' });
  ...
  test.describe('Edge Cases', () => {
    test('should handle step of 1 with all modes', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { step: 1, initval: 10.7, forcestepdivisibility: 'round' });
    ...
    test('should handle very small decimal steps', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { step: 0.001, initval: 5.0015, forcestepdivisibility: 'round' });
    ...
    test('should handle large step values', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { step: 100, initval: 150, forcestepdivisibility: 'round' });
    ...
    test('should respect min/max boundaries after step adjustment', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { step: 3, min: 10, max: 20, initval: 22, forcestepdivisibility: 'floor' });
