...
var TouchSpinBS3 = (() => {
  ...
  // ../renderers/bootstrap3/dist/index.js
  var Bootstrap3Renderer = class extends AbstractRenderer_default {
    constructor() {
      super(...arguments);
      this.prefixEl = null;
      this.postfixEl = null;
    ...
    buildBasicInputGroup() {
      ...
      if (this.settings.verticalbuttons) {
        const prefixEl = wrapper ? wrapper.querySelector('[data-touchspin-injected="prefix"]') : null;
        const postfixEl = wrapper ? wrapper.querySelector('[data-touchspin-injected="postfix"]') : null;
        if (prefixEl && wrapper) {
          wrapper.insertBefore(this.input, prefixEl.nextSibling);
        } else if (postfixEl && wrapper) {
          wrapper.insertBefore(this.input, postfixEl);
        } else {
          const verticalWrapper = wrapper == null ? void 0 : wrapper.querySelector('[data-touchspin-injected="vertical-wrapper"]');
        ...
        const postfixEl = wrapper ? wrapper.querySelector('[data-touchspin-injected="postfix"]') : null;
        if (prefixEl) {
          if (wrapper) wrapper.insertBefore(this.input, prefixEl.nextSibling);
        } else {
          const downButton = wrapper == null ? void 0 : wrapper.querySelector('[data-touchspin-injected="down-wrapper"]');
  ...
  // src/jquery-touchspin-bs3.ts
  installWithRenderer(Bootstrap3Renderer_default);
})();
