 ...
 * [x] preserves Bootstrap 3 component structure in both modes
...
test('preserves Bootstrap 3 component structure in both modes', async ({ page }) => {
  ...
  // Verify Bootstrap 3 structure for horizontal layout
  await expect(elements.wrapper).toHaveClass(/input-group/);
  ...
  // Verify Bootstrap 3 structure for vertical layout
