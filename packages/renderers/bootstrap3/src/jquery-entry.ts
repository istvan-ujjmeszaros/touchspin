...
import { TouchSpin as CoreTouchSpin, TouchSpinCore, getTouchSpin, CORE_EVENTS } from '../../../core/src/index';
...
export { TouchSpin, TouchSpinCore, getTouchSpin, Bootstrap3Renderer, installJqueryTouchSpin };
