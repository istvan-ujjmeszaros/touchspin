 ...
 * [x] supports Bootstrap 4 button styling and states
 * [x] handles Bootstrap 4 form validation states
 * [x] integrates with Bootstrap 4 sizing utilities
 * [x] supports Bootstrap 4 color scheme and themes
 * [x] handles Bootstrap 4 responsive breakpoints
 * [x] integrates with Bootstrap 4 flex utilities
 * [x] supports Bootstrap 4 spacing utilities
 * [x] handles Bootstrap 4 border utilities
 * [x] integrates with Bootstrap 4 focus management
 * [x] supports Bootstrap 4 disabled states
 * [x] handles Bootstrap 4 form control variants
 * [x] integrates with Bootstrap 4 input group addons
 * [x] supports Bootstrap 4 button group behavior
 * [x] handles Bootstrap 4 accessibility features
 * [x] integrates with Bootstrap 4 custom properties
 * [x] supports Bootstrap 4 dark mode compatibility
 * [x] handles Bootstrap 4 RTL language support
 * [x] integrates with Bootstrap 4 form layouts
 * [x] supports Bootstrap 4 floating labels
 * [x] handles Bootstrap 4 input group sizing
 * [x] integrates with Bootstrap 4 validation feedback
 * [x] supports Bootstrap 4 tooltip integration
 * [x] handles Bootstrap 4 dropdown integration
 */
 ...
 * Then it follows Bootstrap 4 input-group specifications
 * Params:
 * { "frameworkVersion": "bootstrap4", "componentType": "input-group", "expectedCompliance": "bootstrap4_specs" }
 */
 ...
 */
test('supports Bootstrap 4 button styling and states', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
 ...
 */
test('handles Bootstrap 4 form validation states', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
  await apiHelpers.initializeTouchspinFromGlobals(page, 'test-input');
 ...
 */
test('integrates with Bootstrap 4 sizing utilities', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
 ...
 */
test('supports Bootstrap 4 color scheme and themes', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
  await apiHelpers.initializeTouchspinFromGlobals(page, 'test-input');
 ...
 */
test('handles Bootstrap 4 responsive breakpoints', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
  await apiHelpers.initializeTouchspinFromGlobals(page, 'test-input');
...
/**
 * Scenario: integrates with Bootstrap 4 flex utilities
 ...
 */
test('integrates with Bootstrap 4 flex utilities', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
 ...
 */
test('supports Bootstrap 4 spacing utilities', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
 ...
 */
test('handles Bootstrap 4 border utilities', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
 ...
 * Then Bootstrap 4 focus styling and behavior is correct
 * Params:
 * { "focusElements": ["input", "buttons"], "expectedFocusRing": "bootstrap4_focus_ring", "keyboardNavigation": true }
 */
test('integrates with Bootstrap 4 focus management', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
  await apiHelpers.initializeTouchspinFromGlobals(page, 'test-input');
 ...
 * Then they display proper Bootstrap 4 disabled styling
 * Params:
 * { "disabledElements": ["input", "buttons"], "expectedStyling": "bootstrap4_disabled_appearance", "interactionBlocked": true }
 */
test('supports Bootstrap 4 disabled states', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
 ...
 * Then it works correctly with all Bootstrap 4 form control types
 * Params:
 * { "formControlTypes": ["form-control", "form-control-plaintext", "form-select"], "expectedCompatibility": "universal_support" }
 */
test('handles Bootstrap 4 form control variants', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
 ...
 * Then it integrates seamlessly with Bootstrap 4 addons
 * Params:
 * { "addonTypes": ["input-group-prepend", "input-group-append", "input-group-text"], "expectedIntegration": "seamless_coexistence" }
 */
test('integrates with Bootstrap 4 input group addons', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
 ...
 * Then they follow Bootstrap 4 button group conventions
 * Params:
 * { "buttonGroupTypes": ["btn-group", "btn-group-vertical"], "expectedBehavior": "button_group_integration" }
 */
test('supports Bootstrap 4 button group behavior', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
  await apiHelpers.initializeTouchspinFromGlobals(page, 'test-input');
 ...
 * Then it supports Bootstrap 4 accessibility standards
 * Params:
 * { "accessibilityFeatures": ["screen_reader_support", "keyboard_navigation", "focus_management"], "standardsCompliance": "wcag_2.1" }
 */
test('handles Bootstrap 4 accessibility features', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
  await apiHelpers.initializeTouchspinFromGlobals(page, 'test-input');
 ...
 * Given the fixture page is loaded with Bootstrap 4 CSS custom properties
 * When TouchSpin uses Bootstrap 4 theming variables
 ...
 */
test('integrates with Bootstrap 4 custom properties', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
...
/**
 * Scenario: supports Bootstrap 4 dark mode compatibility
 * Given the fixture page is loaded with Bootstrap 4 dark mode
 ...
 */
test('supports Bootstrap 4 dark mode compatibility', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
...
/**
 * Scenario: handles Bootstrap 4 RTL language support
 ...
 */
test('handles Bootstrap 4 RTL language support', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
 ...
 */
test('integrates with Bootstrap 4 form layouts', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
...
/**
 * Scenario: supports Bootstrap 4 floating labels
 * Given the fixture page is loaded with floating label setup
 * When TouchSpin is used with Bootstrap 4 floating labels
 ...
 */
test('supports Bootstrap 4 floating labels', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
 ...
 */
test('supports Bootstrap 4 tooltip integration', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
  await apiHelpers.initializeTouchspinFromGlobals(page, 'test-input');
...
/**
 * Scenario: handles Bootstrap 4 dropdown integration
 ...
 */
test('handles Bootstrap 4 dropdown integration', async ({ page }) => {
  await page.goto('/packages/renderers/bootstrap4/tests/fixtures/bootstrap4-fixture.html');
