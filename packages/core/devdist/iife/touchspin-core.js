...
var TouchSpinCore = (() => {
  ...
  var TouchSpinEmittedEvent = /* @__PURE__ */ ((TouchSpinEmittedEvent2) => {
    TouchSpinEmittedEvent2["ON_MIN"] = "touchspin.on.min";
    TouchSpinEmittedEvent2["ON_MAX"] = "touchspin.on.max";
    TouchSpinEmittedEvent2["ON_START_SPIN"] = "touchspin.on.startspin";
    TouchSpinEmittedEvent2["ON_STOP_SPIN"] = "touchspin.on.stopspin";
    TouchSpinEmittedEvent2["ON_START_UP_SPIN"] = "touchspin.on.startupspin";
    TouchSpinEmittedEvent2["ON_START_DOWN_SPIN"] = "touchspin.on.startdownspin";
    TouchSpinEmittedEvent2["ON_STOP_UP_SPIN"] = "touchspin.on.stopupspin";
    TouchSpinEmittedEvent2["ON_STOP_DOWN_SPIN"] = "touchspin.on.stopdownspin";
    return TouchSpinEmittedEvent2;
  ...
  var TouchSpinCore = class _TouchSpinCore {
    ...
    constructor(inputEl, opts = {}) {
      ...
      __publicField(this, "spincount");
      __publicField(this, "direction");
      __publicField(this, "_teardownCallbacks", []);
      __publicField(this, "_settingObservers", /* @__PURE__ */ new Map());
      __publicField(this, "_spinDelayTimeout", null);
      __publicField(this, "_spinIntervalTimer", null);
      __publicField(this, "_upButton", null);
      __publicField(this, "_originalAttributes", null);
      __publicField(this, "_downButton", null);
  ...
  var index_default = TouchSpinCore;
  return __toCommonJS(index_exports);
})();
//# sourceMappingURL=touchspin-core.js.map