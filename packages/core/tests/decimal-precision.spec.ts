...
test.describe('Core TouchSpin Decimal Precision', () => {
  ...
  test.afterEach(async ({ page }) => {
    await apiHelpers.collectCoverage(page, 'core-decimal-precision');
  });

  test.describe('Decimal Display Formatting', () => {
    test('should format values with specified decimal places', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 2, step: 0.01, initval: 5.50 });
    ...
    test('should handle zero decimal places', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 0, step: 1, initval: 5.75 });
    ...
    test('should handle large decimal place counts', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 6, step: 0.000001, initval: 3.123456 });
    ...
    test('should round values for display correctly', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 2, step: 0.01, initval: 5.555 });
  ...
  test.describe('Precision in Calculations', () => {
    test('should maintain precision during arithmetic operations', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 2, step: 0.1, initval: 0.1 });
    ...
    test('should handle step operations with decimals', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 2, step: 0.25, initval: 5.00 });
    ...
    test('should avoid floating point accumulation errors', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 2, step: 0.01, initval: 0.00 });
    ...
    test('should handle boundary checks with decimal precision', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 2, min: 0.05, max: 0.95, step: 0.05, initval: 0.50 });
  ...
  test.describe('Decimal Input Processing', () => {
    test('should parse decimal input correctly', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 2, step: 0.01 });
    ...
    test('should validate decimal input format', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 2, step: 0.01, initval: 5.00 });
  ...
  test.describe('Edge Cases', () => {
    test('should handle very small decimal values', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 6, step: 0.000001, initval: 0.000001 });
    ...
    test('should handle very large decimal values', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 2, max: null, step: 0.01, initval: 999999.99 });
    ...
    test('should handle scientific notation input', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 6, step: 0.000001 });
    ...
    test('should handle JavaScript precision limits', async ({ page }) => {
      await initializeTouchspin(page, 'test-input', { decimals: 10, step: 0.0000000001, initval: 0.1234567890 });
    ...
    test('should handle invalid decimals configuration', async ({ page }) => {
      ...
      await initializeTouchspin(page, 'test-input', { decimals: -1, step: 1, initval: 5.75 });
