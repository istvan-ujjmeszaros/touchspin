...
/**
 * Abstract renderer using metadata tracking strategy.
 * Captures DOM snapshots with fingerprints and uses nested set hierarchy for restoration.
 * Suitable for Bootstrap3, Bootstrap4, Vanilla, and Tailwind renderers.
 */
