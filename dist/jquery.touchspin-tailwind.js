  ...
  var TailwindRenderer = /*#__PURE__*/function (_AbstractRenderer) {
    ...
    return _createClass(TailwindRenderer, [{
      ...
      value: function buildBasicInputGroup() {
        ...
        var html;
        if (isVertical) {
          html = "\n        <div class=\"flex rounded-md shadow-sm border border-gray-300 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 has-[:disabled]:opacity-60 has-[:disabled]:bg-gray-50 has-[:read-only]:bg-gray-50\" data-touchspin-injected=\"wrapper\"".concat(testidAttr, ">\n          <span class=\"inline-flex items-center px-3 py-2 bg-gray-50 text-gray-600 border-0 tailwind-addon ").concat(this.settings.prefix_extraclass || '', "\" data-touchspin-injected=\"prefix\">").concat(this.settings.prefix || '', "</span>\n          ").concat(this.buildVerticalButtons(), "\n          <span class=\"inline-flex items-center px-3 py-2 bg-gray-50 text-gray-600 border-0 tailwind-addon ").concat(this.settings.postfix_extraclass || '', "\" data-touchspin-injected=\"postfix\">").concat(this.settings.postfix || '', "</span>\n        </div>\n      ");
        } else {
