  ...
  var TouchSpinCore = /*#__PURE__*/function () {
    ...
    return _createClass(TouchSpinCore, [{
      ...
      value: function _startSpin(dir) {
        ...
        var direction_changed = !this.spinning || this.direction !== dir;
  ...
  var TailwindRenderer = /*#__PURE__*/function (_AbstractRenderer) {
    ...
    return _createClass(TailwindRenderer, [{
      ...
      value: function buildBasicInputGroup() {
        ...
        var html;
        if (isVertical) {
          html = "\n        <div class=\"flex rounded-md shadow-sm border border-gray-300 focus-within:ring-2 focus-within:ring-blue-500 focus-within:border-blue-500 has-[:disabled]:opacity-60 has-[:disabled]:bg-gray-50 has-[:read-only]:bg-gray-50\">\n          <span class=\"inline-flex items-center px-3 py-2 bg-gray-50 text-gray-600 border-0 rounded-l-md tailwind-addon ".concat(this.settings.prefix_extraclass || '', "\" data-touchspin-injected=\"prefix\"").concat(this.getPrefixTestId(), ">").concat(this.settings.prefix || '', "</span>\n          <span class=\"inline-flex items-center px-3 py-2 bg-gray-50 text-gray-600 border-0 tailwind-addon ").concat(this.settings.postfix_extraclass || '', "\" data-touchspin-injected=\"postfix\"").concat(this.getPostfixTestId(), ">").concat(this.settings.postfix || '', "</span>\n          ").concat(this.buildVerticalButtons(), "\n        </div>\n      ");
        } else {
      ...
      value: function buildVerticalButtons() {
        return "\n      <div class=\"flex flex-col\" data-touchspin-injected=\"vertical-wrapper\">\n        <button tabindex=\"".concat(this.settings.focusablebuttons ? '0' : '-1', "\" class=\"inline-flex items-center justify-center px-2 py-1 text-xs ").concat(this.settings.verticalupclass || 'bg-gray-100 hover:bg-gray-200 text-gray-700', " font-medium border border-gray-300 rounded-tr tailwind-btn disabled:opacity-50 disabled:cursor-not-allowed\" data-touchspin-injected=\"up\"").concat(this.getUpButtonTestId(), " type=\"button\" aria-label=\"Increase value\">").concat(this.settings.verticalup || '+', "</button>\n        <button tabindex=\"").concat(this.settings.focusablebuttons ? '0' : '-1', "\" class=\"inline-flex items-center justify-center px-2 py-1 text-xs ").concat(this.settings.verticaldownclass || 'bg-gray-100 hover:bg-gray-200 text-gray-700', " font-medium border border-t-0 border-gray-300 rounded-br tailwind-btn disabled:opacity-50 disabled:cursor-not-allowed\" data-touchspin-injected=\"down\"").concat(this.getDownButtonTestId(), " type=\"button\" aria-label=\"Decrease value\">").concat(this.settings.verticaldown || '−', "</button>\n      </div>\n    ");
      }
    }, {
