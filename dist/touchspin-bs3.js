  ...
  var Bootstrap3Renderer = /*#__PURE__*/function (_AbstractRenderer) {
    ...
    return _createClass(Bootstrap3Renderer, [{
      ...
      value: function buildBasicInputGroup() {
        ...
        var upButton = wrapper.querySelector('.input-group-btn:has([data-touchspin-injected="up"])');
      ...
      value: function buildAdvancedInputGroup(existingInputGroup) {
        ...
        var downButtonWrapper = tempDiv.querySelector('.input-group-btn:has([data-touchspin-injected="down"])');
        existingInputGroup.insertBefore(downButtonWrapper, this.input);

        // Insert up button after the input
        var upButtonWrapper = tempDiv.querySelector('.input-group-btn:has([data-touchspin-injected="up"])');
